                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration( // Added 'const' here
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/images/default_user.png'), // Reemplaza con tu imagen predeterminada
                      ),
                    ),
                  ),
                  const SizedBox(height: 15), // Added 'const' here
                  Text(state.userEntity.email!),
                  const SizedBox(height: 10), // Added 'const' here
                  Text(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(
                                        'assets/images/${state.favoriteSongs[index].artist} - ${state.favoriteSongs[index].title}.jpg', // Asegúrate de que el nombre del archivo coincida
                                      ),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
